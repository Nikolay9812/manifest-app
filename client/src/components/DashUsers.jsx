...
import { Table, Modal, Button, TextInput, Alert, Label, Spinner } from 'flowbite-react';
          ...
          <div className="max-w-lg mx-auto p-3 w-full">
            ...
            <form onSubmit={handleEditSubmit} className="flex flex-col gap-4">
              ...
              <div className="relative w-32 h-32 self-center cursor-pointer shadow-md overflow-hidden rounded-full" onClick={() => filePickerRef.current.click()}>
                ...
                <img src={imageFileUrl || selectedUser?.profilePicture} alt="user"
          ...
          <div className='max-w-lg mx-auto p-3 w-full'>
            <form className="flex flex-col gap-4" onSubmit={handleAddUserSubmit}>
              <div>
                ...
                <TextInput type="text" placeholder="Username" id="username" onChange={handleAddUserChange} />
              </div>
              <div>
                <Label value="Email" />
                <TextInput type="email" placeholder="name@company.com" id="email" onChange={handleAddUserChange} />
              </div>
              <div>
                <Label value="Password" />
                <TextInput type="password" placeholder="Password" id="password" onChange={handleAddUserChange} />
              </div>
