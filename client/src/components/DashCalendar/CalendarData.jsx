...
const CalendarData = ({ manifest }) => {
    return (
        <>
            <div className={`relative w-10 h-10 ${manifest.secondUserId ? 'mr-4' : ''}`}>
                <div className="group">
                    <img src={manifest.profilePicture} alt="user" className='absolute w-full h-full rounded-full z-10 border-2 dark:border-slate-500 border-slate-300 transition-scale duration-300 hover:scale-150 hover:z-50' />
                ...
                {manifest.secondUserId && manifest.secondProfilePicture &&
                    <div className="group">
                        <img src={manifest.secondProfilePicture} alt="user" className='absolute w-full h-full rounded-full ml-4 border-2 dark:border-slate-600 border-slate-400 transition-scale duration-300 hover:scale-150 hover:z-50' />
