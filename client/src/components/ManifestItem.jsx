...
const ManifestItem = ({ manifest, userId }) => {
    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-2 gap-y-3  text-slate-700 dark:text-slate-400 italic">
            <div className="dark:bg-gray-700 rounded-lg shadow-xl min-h-[100px] row-span-4 col-span-2 md:col-auto  flex flex-col items-center justify-center gap-6 p-6 ">
                    ...
                    <div className="relative w-20 h-20">
                        ...
                        {secondDriverUser && secondDriverUser.profilePicture && (
                            <img
                                ...
                                className="absolute w-full h-full rounded-full ml-7 border-4 dark:border-slate-600 border-slate-400"
                            />
                        )}
                    </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="border border-gray-400 rounded-full p-1 pl-2 pr-2 dark:text-white text-sm">{manifest.stantion}</div>
                </div>
                <div className="flex items-center gap-3">
                    <span className=' text-sm '>Tor:</span>
                    <LuMapPin />
                    <div className="border border-gray-400 rounded-full p-1 pl-2 pr-2 dark:text-white text-sm">{manifest.tor}</div>
                </div>
                <div className="flex items-center gap-3">
                    <span className=' text-sm '>Plate:</span>
                    <FiTruck />
                    <div className="border border-gray-400 rounded-full p-1 pl-2 pr-2 dark:text-white text-sm">{manifest.plate}</div>
                </div>
                <div className="flex items-center gap-3">
            ...
            <div className="dark:bg-gray-700 rounded-lg shadow-xl min-h-[100px] col-span-2 text-3xl flex item-center justify-center gap-10">
            ...
            <div className="dark:bg-gray-700 rounded-lg shadow-xl min-h-[100px] row-span-2 flex flex-col items-center justify-center gap-6 p-6">
                <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <CiClock2 />
                    <div className="border border-gray-400 rounded-full p-1 pl-2 pr-2 text-sm dark:text-white">{manifest.departure}</div>
                </div>
                <div className="flex items-center gap-3">
                    <span className=' text-sm '>Time of first delivery:</span>
                    <CiClock2 />
                    <div className="border border-gray-400 rounded-full p-1 pl-2 pr-2 text-sm dark:text-white">{manifest.firstDelivery}</div>
                </div>
                <div className="flex items-center gap-3">
                    <span className=' text-sm '>Time of last delivery:</span>
                    <CiClock2 />
                    <div className="border border-gray-400 rounded-full p-1 pl-2 pr-2 dark:text-white text-sm">{manifest.lastDelivery}</div>
                </div>
                <div className="flex items-center gap-3">
                    <span className=' text-sm '>Return time station:</span>
                    <CiClock2 />
                    <div className="border border-gray-400 rounded-full p-1 pl-2 pr-2 dark:text-white text-sm">{manifest.returnTime}</div>
                </div>
                <div className="flex items-center gap-3">
            ...
            <div className="dark:bg-gray-700 rounded-lg shadow-xl min-h-[100px]  text-slate-400 flex flex-col items-center justify-center">
            ...
            <div className="dark:bg-gray-700 rounded-lg shadow-xl min-h-[100px]  text-slate-400 flex flex-col items-center justify-center text-3xl">
                <MdOutlineFreeBreakfast />
                <div className="flex gap-3 items-center p-6">
                    <span>Break:</span>
                    <span className='dark:text-white'>{manifest.workingHours <= 8.5 ? "30 min" : "45 min"}</span>

                </div>
            </div>
            <div className="dark:bg-gray-700 rounded-lg shadow-xl min-h-[100px] col-span-2 flex justify-around p-10">
                <div className="flex gap-3 items-center">
