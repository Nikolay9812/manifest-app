...
// CORS Configuration
app.use(cors({
    origin: process.env.FRONTEND_URL, // Use your frontend URL from environment variables
    credentials: true,
}));
...
app.use('/api/stantion', stationRoutes); // Ensure this matches the correct route
